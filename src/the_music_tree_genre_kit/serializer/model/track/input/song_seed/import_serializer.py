...
from .entry_serializer import SongSeedEntrySerializer


class SongSeedImportSerializer(AppInputSerializer):
    ...
    songs = ListField(child=SongSeedEntrySerializer(), allow_empty=False)
